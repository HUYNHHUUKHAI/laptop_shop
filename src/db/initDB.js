...
module.exports = async () => {
    ...
    if (user.length == 0) {
        listLaptop = [{
            ...
            "usb": "Jack tai nghe 3.5 mm HDMI2 x USB Type-A1 x USB Type-C (chỉ hỗ trợ truyền dữ liệu)",
            "os": "Windows 11 Home SL",
            "design": "Vỏ nhựa",
            "size": "Dài 358.5 mm - Rộng 242 mm - Dày 17.9 mm - Nặng 1.69 kg",
            "time": "2023"
        },
        {
